...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if test "${ac_cv_path_SHELL_PATH+set}" = set; then :
  $as_echo_n "(cached) " >&6
else
  case $SHELL_PATH in
  [\\/]* | ?:[\\/]*)
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if test "${ac_cv_path_FAKEROOT_PATH+set}" = set; then :
  $as_echo_n "(cached) " >&6
else
...
if test "${ac_cv_lib_z_deflateParams+set}" = set; then :
  $as_echo_n "(cached) " >&6
else
  ac_check_lib_save_LIBS=$LIBS
LIBS="-lz  $LIBS"
...
if test "x$ac_cv_lib_z_deflateParams" = x""yes; then :
  cat >>confdefs.h <<_ACEOF
#define HAVE_LIBZ 1
_ACEOF
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if test "${ac_cv_path_STUNNEL+set}" = set; then :
  $as_echo_n "(cached) " >&6
else
  case $STUNNEL in
  [\\/]* | ?:[\\/]*)
...
{ $as_echo "$as_me:${as_lineno-$LINENO}: checking for $ac_word" >&5
$as_echo_n "checking for $ac_word... " >&6; }
if test "${ac_cv_path_STUNNEL4+set}" = set; then :
  $as_echo_n "(cached) " >&6
else
  case $STUNNEL4 in
  [\\/]* | ?:[\\/]*)
